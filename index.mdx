---
title: "Introduction"
description: "Welcome to the new home for your documentation HELLO! 👋"
---

import { CustomHeader } from '/snippets/custom-header.mdx';

<CustomHeader title={'Custom header title'} />
...
<Columns cols={2}>
  <Card title="Write with MDX" icon="pen-fancy" color="#3abd54" horizontal href="/essentials/markdown">
